        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () =>
                  Navigator.pop(sheetContext, StudentFlashcardCardType.essay),
            ),
            ListTile(
              ...
              onTap: () =>
                  Navigator.pop(sheetContext, StudentFlashcardCardType.quiz),
            ),
            const SizedBox(height: 12),
          ],
        ),
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
            ...
            maxLines: 3,
            style: TextStyle(color: colors.text),
            decoration: const InputDecoration(labelText: 'Mặt trước (câu hỏi)'),
          ),
          const SizedBox(height: 12),
          TextField(
